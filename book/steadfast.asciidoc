...
|https://example.com |Bare real website URL.
https scheme is assumed and omitted.
|https://example.com[Example domain] |Named real website URL.
...
The file is https://asciidoc.org[AsciiDoc] plain text markup.
...
* heck, the military industrial complex brought us the Internet, so yeah, sometimes we get lucky with good outcomes regardless of the https://en.wikipedia.org/wiki/History_of_the_Internet[original motivation]
...
* FOSS dovetails nicely with the principles of https://inkandswitch.com/local-first/[Local-first software]
...
* FOSS sidesteps https://doctorow.medium.com/twiddler-1b5c9690cce6[twiddling] -- when online platforms change their settings/rules in bad faith, in a way traditional businesses cannot
