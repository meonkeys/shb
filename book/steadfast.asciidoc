...
// FIXME - maybe change chapter title
//
// * Strategic FOSS
// * FOSS pros and cons
// * FOSS strategies
...
FOSS (free and open source software) is a core _Steadfast_ value.
This chapter exists to bring the focus back around to FOSS, taking a deeper look at its benefits and challenges.
...
That never happens with FOSS, rather, you end up with the opposite challenge.
...
// FIXME - restructure as a con, add strong rebuttal
