...
I'll assume you're using Duck DNS -- see <<Server domain name>> for details and alternatives.
...
Edit those values and run `provision.sh` again.
...
|Jellyfin |jellyfin.example.com |175.102.205.1 |10.0.0.5
|Wallabag |wallabag.example.com |175.102.205.1 |10.0.0.5
|===
