...
I use mobile apps and integrations for Nextcloud, Jellyfin, and Wallabag often.
...
Or, use https://containrrr.dev/watchtower/arguments/[configuration settings] to allow or deny auto-upgrades for particular containers.
