...
(((data sovereignty)))
Data sovereignty (full control of your data) is achievable for small communities as well as corporations and can support ((prosocial behavior)).
Self-hosting following this book is an excellent path to data sovereignty.

This book will help you efficiently learn the basics about self-hosting while promoting prosocial behavior.
...
Bring along whatever ((sysadmin)) experience you've got, willing users, and a desire to do well at self-hosting.
...
* Save money
** in the long run
** especially once your users' data storage requirements enter the terabyte range
...
** When you buy something, _it's yours_.
...
I knew where I was when I took the photos (within 10 miles or so) and my photos have embedded geo metadata.
