...
reverse proxy::
  Networking software for filtering and directing traffic. It allows, for example, several self-hosted web services with different domain names to share an IP address. Reverse proxies are used for web service scaling and fault-toleranace in enterprise settings.
router::
