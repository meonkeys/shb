...
During its first run, mario configures the server to require public key authentication for SSH logins.
If you want to be able to use a password, delete the related task from `roles/base/tasks/main.yml`.
