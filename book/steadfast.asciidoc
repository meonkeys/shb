...
I started dabbling more with self-hosting at home and found it was possible to provide safer, better family tech services then many popular ones available online.
I wanted more services for managing our data and I enjoyed the autonomy of our own ((bare metal)).

Around the same time, I decided to https://en.wikipedia.org/wiki/DeGoogle[de-Google].
