...
Like a crotchety old man I'm reluctant to change, but I still do, sometimes.
If I'm going to change, that next cool thing needs to pass a high bar.
Ideally most or all these tests:
