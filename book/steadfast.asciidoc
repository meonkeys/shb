...
[%unbreakable]
TIP: Some CPUs include special facilities for accelerated transcoding, and Jellyfin can take advantage of this.
If you have an Intel chip, look for Quick Sync Video support.
