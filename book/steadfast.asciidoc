...
You may also skip ahead to <<Prepare hardware>> to continue on the path of using the services mario installs by default, then return to this section when you are considering other services to add.
...
https://kernel.org/doc/html/latest/accounting/psi.html[Read more about PSI].
