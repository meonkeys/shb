...
Here are a couple decent introductory articles about ZFS on Ars Technica:
...
If you choose to dig deeper with ZFS, start by reading up on fragmentation, ARC (adaptive replacement cache), and `recordsize`.
